...
@section('content')
    <div
        ...
        <div class="flex flex-col md:flex-row items-center justify-center gap-8 w-full max-w-4xl mb-12" data-aos="zoom-in">
            ...
            <ul class="w-full md:w-1/3 text-sm grid grid-cols-1 gap-2">
                <li class="flex items-center gap-x-2"><i class="fa-solid fa-check text-teal-500"></i> Quản lý chi tiêu
                    dễ
                    dàng</li>
                <li class="flex items-center gap-x-2"><i class="fa-solid fa-check text-teal-500"></i> Thống kê thông
                    minh
                </li>
                <li class="flex items-center gap-x-2"><i class="fa-solid fa-check text-teal-500"></i> Hoàn toàn miễn phí
                </li>
                <li class="flex items-center gap-x-2"><i class="fa-solid fa-check text-teal-500"></i> Giao diện trực
                    quan
                </li>
                <li class="flex items-center gap-x-2"><i class="fa-solid fa-check text-teal-500"></i> Hỗ trợ đa thiết bị
                </li>
                <li class="flex items-center gap-x-2"><i class="fa-solid fa-check text-teal-500"></i> Bảo mật tuyệt đối
                </li>
            </ul>
            <div class="w-full md:w-1/3 flex justify-center">
            ...
            <div class="bg-gradient-to-br from-white to-teal-50 p-8 rounded-2xl shadow-xl hover:shadow-2xl transition transform hover:scale-[1.02] duration-200 space-y-6 border border-teal-100"
                ...
                <ul class="space-y-4 text-gray-700">
                    <li class="flex items-start gap-x-3">
                        ...
                        <span><strong>Tạo tài khoản:</strong> Bạn có thể đăng ký bằng e-mail hoặc tài khoản Google.</span>
                    </li>
                    <li class="flex items-start gap-x-3">
                    ...
                    <li class="flex items-start gap-x-3">
                        ...
                        <span><strong>Nạp tiền & Ghi chép:</strong> Nạp tiền và ghi chép chi tiêu, hệ thống tự xử lý và chia
                            sẻ công bằng.</span>
                    </li>
                    <li class="flex items-start gap-x-3">
                        <i class="fa-solid fa-chart-pie text-teal-500 mt-1 text-xl"></i>
                        <span><strong>Thống kê:</strong> Xem chi tiết thống kê chi tiêu của cả phòng bất kỳ lúc nào.</span>
                    </li>
                </ul>
            </div>
    ...
    <div class="w-full min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-teal-100 via-white to-cyan-50 p-6 rounded-[60px_0_60px_0]"
        ...
        <div class="w-full flex flex-col justify-center items-center p-8 space-y-6">
            ...
            <p class="text-base text-gray-600 max-w-md leading-relaxed text-center">
                Bạn có thể tìm thấy câu trả lời cho các câu hỏi thường gặp bên dưới. Nếu bạn cần thêm hỗ trợ, vui lòng liên
            ...
            <ul class="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-2xl text-teal-500 font-medium">
                <li class="flex flex-col p-3 rounded-lg border border-teal-200 hover:bg-teal-50 transition shadow-sm cursor-pointer"
                    ...
                    <div class="faq-content p-4 mt-2 border-t border-teal-100 hidden text-gray-600 text-sm leading-relaxed">
                ...
                <li class="flex flex-col p-3 rounded-lg border border-teal-200 hover:bg-teal-50 transition shadow-sm cursor-pointer"
                    ...
                    <div class="faq-content p-4 mt-2 border-t border-teal-100 hidden text-gray-600 text-sm leading-relaxed">
                        Mọi dữ liệu được mã hóa SSL và bảo mật tuyệt đối. Chỉ bạn và thành viên được mời vào nhóm mới xem
                        được.
                    </div>
                </li>
                ...
                <li class="flex flex-col p-3 rounded-lg border border-teal-200 hover:bg-teal-50 transition shadow-sm cursor-pointer"
                    ...
                    <div
                        ...
                        Sau khi tạo phòng, bạn vào phần "Quản lý phòng" và chọn "Chia sẻ mã mời" để gửi QR code hoặc link
                        mời bạn bè.
                    </div>
                </li>
                ...
                <li class="flex flex-col p-3 rounded-lg border border-teal-200 hover:bg-teal-50 transition shadow-sm cursor-pointer"
                    ...
                    <div
                        class="faq-content p-4 mt-2 border-t border-teal-100 hidden text-gray-600 text-sm leading-relaxed">
                        Có, bạn vào danh sách giao dịch, chọn giao dịch cần chỉnh sửa hoặc xóa, sau đó nhấn nút tương ứng.
                    </div>
                </li>
